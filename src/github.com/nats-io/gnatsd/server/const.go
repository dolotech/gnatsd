...
const (
	...
	VERSION = "1.0.6"		// 当前gnatsd版本号

	// DEFAULT_PORT is the default port for client connections.
	DEFAULT_PORT = 4222		// gnatsd默认供客户端连接的端口号
	...
	MAX_PAYLOAD_SIZE = (1024 * 1024)		// 允许的最大消息大小默认1M

	// DEFAULT_MAX_CONNECTIONS is the default maximum connections allowed.
	DEFAULT_MAX_CONNECTIONS = (64 * 1024)// 允许的最大连接数65536
	...
	DEFAULT_PING_INTERVAL = 2 * time.Minute	// 网络心跳周期时长，默认2分钟

	// DEFAULT_PING_MAX_OUT is maximum allowed pings outstanding before disconnect.
	DEFAULT_PING_MAX_OUT = 2		// 3个周期内心跳超时代表网络已经断开
	...
	DEFAULT_FLUSH_DEADLINE = 2 * time.Second		// 网络套接字写超时，默认2秒
